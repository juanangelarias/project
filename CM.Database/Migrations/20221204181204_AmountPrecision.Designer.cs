...
namespace CM.Database.Migrations
{
    ...
    [Migration("20221204181204_AmountPrecision")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CM.Entities.ConferencePaymentMethod", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasColumnName("ConferencePaymentMethodId");
                    ...
                    b.HasIndex("ConferenceId", "PaymentMethodId")
                        .IsUnique();

                    b.ToTable("ConferencePaymentMethod", (string)null);
                });
            ...
            modelBuilder.Entity("CM.Entities.Inscription", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("ConferenceId", "Date");

                    b.ToTable("Inscription", (string)null);
                });

            modelBuilder.Entity("CM.Entities.InscriptionDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasColumnName("InscriptionDetailId");
                    ...
                    b.ToTable("InscriptionDetail", (string)null);
                });
            ...
            modelBuilder.Entity("CM.Entities.PaymentMethod", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<bool?>("RequireDocumentNumber")
                        .IsRequired()
                        .HasColumnType("bit");

                    b.Property<bool?>("RequiredBankName")
                        .IsRequired()
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("CM.Entities.Program", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("ConferenceId", "DateTime");
            ...
            modelBuilder.Entity("CM.Entities.ConferencePaymentMethod", b =>
                {
                    ...
                    b.HasOne("CM.Entities.PaymentMethod", "PaymentMethod")
                        .WithMany()
            ...
            modelBuilder.Entity("CM.Entities.Inscription", b =>
                {
                    ...
                    b.HasOne("CM.Entities.Currency", "Currency")
                        .WithMany()
            ...
            modelBuilder.Entity("CM.Entities.InscriptionDetail", b =>
                {
                    ...
                    b.HasOne("CM.Entities.Inscription", "Inscription")
                        .WithMany("InscriptionDetails")
                        .HasForeignKey("InscriptionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CM.Entities.Member", "Member")
                        .WithMany()
                    ...
                    b.HasOne("CM.Entities.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("CM.Entities.Inscription", b =>
                {
                    b.Navigation("InscriptionDetails");
                });
